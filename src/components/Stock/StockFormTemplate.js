const StockFormTemplate = ({ required, value, isCar, nameList, isSelect, isPrice, htmlFor, type, title, pHolder, id_name, options, onChange, placeholderOption }) => {
  ...
  return <div className="col-md-6 form-group">
    ...
    {isSelect ? (<select className="form-select form-control" placeholder={pHolder} id={id_name} value={value} name={id_name} onChange={onChange} >
      ...
      <input type={type} className="form-control" id={id_name} value={value} name={id_name} onChange={onChange} required />
