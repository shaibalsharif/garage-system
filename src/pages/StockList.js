...
import StockModalFormTemplate from '../components/Stock/StockModalFormTemplate'
    ...
    },
    {
      ...
      cell: (row) => (
        <button
          ...
          onClick={(e) => { setModalStock(row); setIsOpen(true) }}
        >
          Edit
        </button>
      ), button: true,
      ...
      <div className="container-fliude" >
        ...
        <div className='card'>
          <div className='card-body'>
            <Table data={stock} column={columns} handleAction={rowEvents.onClick} />
